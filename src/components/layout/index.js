...
class Layout extends React.Component {
  constructor(props) {
    ...
    const {profile: {articles, experience, education, leadership}} = props;

    this.sections = [];

    if (articles.length && (experience.length || leadership.length) && (education.length)) {
      this.sections = [
        'home',
        'about',
        'services'
    ...
    } else if ((experience.length || leadership.length) && (education.length) && !articles.length) {
      this.sections = [
        'home',
        'about',
      ]
